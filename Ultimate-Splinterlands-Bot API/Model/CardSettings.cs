...
namespace Ultimate_Splinterlands_Bot_API.Model
{
    public record CardSettings
    {
        ...
        public int WINRATE_MODIFIER_OWNED_CARD_PERCENTAGE { get; set; } = 24;
        public double FLAT_NEGATIVE_MODIFIER_PER_UNOWNED_CARD { get; set; } = 2.5;
        ...
        public bool PLAY_STARTER_CARDS { get; set; } = true;
